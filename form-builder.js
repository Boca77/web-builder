$(function() {
    ...
    const formItems = {
        ...
        'submit-button': `<div class="form-builder-item">
                        <div class="drag-handle">⋮⋮</div>
                        ${formSettingsItem}
                        <button type="submit" class="btn btn-primary" style="width: 100%;" contenteditable="true">Submit</button>
                    </div>`,
    };
    ...
    $("#save-form").click(function() {
        const formHtml = $("#form-sortable").html();

        $(".contact-form").empty();
        $(".contact-form").append(formHtml);
    });
});